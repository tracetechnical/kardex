...
#define HOMING_BUMP_MM      { 30, 10, 2 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 4000, 4000, 4000, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
